...
public class Pala extends PowerUp {
	...
	public Pala(Point m, InteraccionPU interaccion){
		miVisitor = new VisitorPala(interaccion);
		imagen= new ImageIcon[1];
		this.imagen[0] = new ImageIcon(this.getClass().getResource("/Images/pala.png"));
